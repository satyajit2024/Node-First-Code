...
def recive():
    ...
    while True:
        ...
        redis_server.set(
            "current_r", message_list[0] if message_list[0] != None else 0)
        redis_server.set(
            "current_y", message_list[1]if message_list[1] != None else 0)
        redis_server.set(
            "current_b", message_list[2] if message_list[2] != None else 0)
